...
lyr_cultius_1.set('fieldAliases', {'OBJECTID_1': 'OBJECTID_1', 'OBJECTID': 'OBJECTID', 'ID_POLYGON': 'ID_POLYGON', 'SIOSE_CODE': 'SIOSE_CODE', 'SIOSE_XML': 'SIOSE_XML', 'SUPERF_HA': 'SUPERF_HA', 'CODIIGE': 'CODIIGE', 'HILUCS': 'HILUCS', 'SELLADO': 'SELLADO', 'FCC': 'FCC', 'CODBLQ': 'CODBLQ', 'SHAPE_Leng': 'SHAPE_Leng', 'CODIIGE_1': 'CODIIGE_1', 'Paisatge': 'Paisatge', 'Shape_Le_1': 'Shape_Le_1', 'Shape_Area': 'Shape_Area', 'Superficie': 'Superficie', });
lyr_cultius_1.set('fieldImages', {'OBJECTID_1': 'TextEdit', 'OBJECTID': 'TextEdit', 'ID_POLYGON': 'TextEdit', 'SIOSE_CODE': 'TextEdit', 'SIOSE_XML': 'TextEdit', 'SUPERF_HA': 'TextEdit', 'CODIIGE': 'TextEdit', 'HILUCS': 'TextEdit', 'SELLADO': 'TextEdit', 'FCC': 'TextEdit', 'CODBLQ': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'CODIIGE_1': 'TextEdit', 'Paisatge': 'TextEdit', 'Shape_Le_1': 'TextEdit', 'Shape_Area': 'TextEdit', 'Superficie': '', });
lyr_cultius_1.set('fieldLabels', {'OBJECTID_1': 'hidden field', 'OBJECTID': 'hidden field', 'ID_POLYGON': 'hidden field', 'SIOSE_CODE': 'hidden field', 'SIOSE_XML': 'hidden field', 'SUPERF_HA': 'no label', 'CODIIGE': 'hidden field', 'HILUCS': 'hidden field', 'SELLADO': 'hidden field', 'FCC': 'hidden field', 'CODBLQ': 'hidden field', 'SHAPE_Leng': 'hidden field', 'CODIIGE_1': 'hidden field', 'Paisatge': 'inline label - visible with data', 'Shape_Le_1': 'hidden field', 'Shape_Area': 'hidden field', 'Superficie': 'inline label - visible with data', });
